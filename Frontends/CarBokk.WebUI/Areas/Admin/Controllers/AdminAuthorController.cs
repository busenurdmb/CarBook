...
namespace CarBokk.WebUI.Areas.Admin.Controllers
{
    ...
    public class AdminAuthorController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:7071/api/Authors");
        ...
        public async Task<IActionResult> CreateAuthor(CreateAuthorDto createAuthorDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7071/api/Authors", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync("https://localhost:7071/api/Authors?id=" + id);
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index", "AdminAuthor", new { area = "Admin" });
            }
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var resposenMessage = await client.GetAsync($"https://localhost:7071/api/Authors/{id}");
