...
namespace CarBook.WebApi.Controllers
{
    ...
    {
        private readonly ICommentRepository<Comment> _commentsRepository;
        private readonly IMediator _mediator;
        public CommentsController(ICommentRepository<Comment> commentsRepository, IMediator mediator)
        {
